...
Chú ý:   Hàm exec chỉ trả về khi có lỗi xảy ra. Kkhi hàm exec() thành công, nó sẽ thay thế chương trình cũ bằng chương 
    ...
    +, Bản chất lệnh System()
        ...
        trong quá trình gọi cho hệ thống (). (Các tín hiệu này sẽ được xử lý theo mặc định của chúng bên trong quy trình của trẻ em thực thi lệnh.) 
        Nếu lệnh là null, thì System () trả về trạng thái cho biết liệu shell có thể thực thi được trên hệ thống không.